...
Both workflows are introduced in the distinct chapters including their required input parameter (chapter \@ref(workflows)). Technical relevant information are summarised in chapter \@ref(tables).
